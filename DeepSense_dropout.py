...
def ConvLayers(split):
    ...
    sen1_conv1 = Conv1D(CONV_NUM,
                        ...
                        padding='valid',
                        activation='relu')(exp)
    drop1 = Dropout(0.2)(sen1_conv1)
    sen1_batch1 = BatchNormalization()(drop1)
    ...
    drop2= Dropout(0.2)(sen1_conv2)
    sen1_batch2 = BatchNormalization()(drop2)
    ...
    drop3= Dropout(0.2)(sen1_conv3)
    sen1_batch3 = BatchNormalization()(drop3)
